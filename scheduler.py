...
class SmartScheduler:
    ...
    def scheduled_ipo_notification(self):
        """Execute scheduled IPO notification at 5:30 PM - send push notifications for open IPOs"""
        try:
            logger.info("=== Scheduled IPO Notification (5:30 PM) ===")
    ...
    def start(self):
        ...
        try:
            ...
            # Job 3: IPO notification - once daily at 5:30 PM (send push notifications)
            self.scheduler.add_job(
                ...
                id='ipo_notification',
                name='Daily IPO Notification (5:30 PM)',
                max_instances=1,
                replace_existing=True
            )
            ...
            logger.info("IPO notifications: Once daily at 5:30 PM on market days (Sun-Thu)")
