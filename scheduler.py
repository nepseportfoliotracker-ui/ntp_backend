...
class SmartScheduler:
    ...
    def scheduled_ipo_notification(self):
        """Execute scheduled IPO notification at 5:19 PM - send push notifications for open IPOs"""
        try:
            logger.info("=== Scheduled IPO Notification (5:19 PM) ===")
    ...
    def start(self):
        ...
        try:
            ...
            # Job 3: IPO notification - once daily at 5:19 PM (send push notifications)
            self.scheduler.add_job(
                ...
                id='ipo_notification',
                name='Daily IPO Notification (5:19 PM)',
                max_instances=1,
                replace_existing=True
            )
            
            # Job 4: NEPSE history scraping - once daily at 4 PM (after market close)
            self.scheduler.add_job(
            ...
            logger.info("IPO notifications: Once daily at 5:19 PM on market days (Sun-Thu)")
